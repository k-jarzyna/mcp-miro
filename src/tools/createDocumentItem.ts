...
const createDocumentItemTool: ToolSchema = {
  ...
  args: {
    ...
    data: z.object({
      ...
      title: z.string().optional().nullable().describe("Title of the document")
    ...
    geometry: z.object({
      width: z.number().optional().nullable().describe("Width of the document"),
      height: z.number().optional().nullable().describe("Height of the document")
    }).optional().nullable().describe("Dimensions of the document")
  },
