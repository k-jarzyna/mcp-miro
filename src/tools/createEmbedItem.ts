...
const createEmbedItemTool: ToolSchema = {
  ...
  args: {
    ...
    data: z.object({
      ...
      mode: z.string().optional().nullable().describe("Mode of the embed (normal, inline, etc.)")
    ...
    geometry: z.object({
      width: z.number().optional().nullable().describe("Width of the embed"),
      height: z.number().optional().nullable().describe("Height of the embed")
    })
