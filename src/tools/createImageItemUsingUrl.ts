...
const createImageItemUsingUrlTool: ToolSchema = {
  ...
  args: {
    ...
    data: z.object({
      ...
      title: z.string().optional().nullable().describe("Title of the image")
    ...
    position: z.object({
      ...
      origin: z.string().optional().nullable().describe("Origin of the image (center, top-left, etc.)"),
    ...
    geometry: z.object({
      width: z.number().optional().nullable().describe("Width of the image"),
      height: z.number().optional().nullable().describe("Height of the image")
    }).optional().nullable().describe("Dimensions of the image")
  },
