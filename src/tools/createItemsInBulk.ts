...
const stickyNoteSchema = z.object({
  ...
  data: z.object({
    ...
    shape: z.enum(['square', 'rectangle']).optional().nullable().describe("Shape of the sticky note")
  }),
  position: z.object({
  ...
  style: z.object({
    fillColor: z.string().optional().nullable().describe("Fill color of the sticky note"),
    textAlign: z.enum(['left', 'center', 'right']).optional().nullable().describe("Text alignment")
  }).optional().nullable()
});
...
const cardSchema = z.object({
  ...
  data: z.object({
    ...
    description: z.string().optional().nullable().describe("Description of the card"),
    assigneeId: z.string().optional().nullable().describe("User ID of the assignee"),
    dueDate: z.string().optional().nullable().describe("Due date in ISO 8601 format")
  }),
  position: z.object({
    x: z.number().describe("X coordinate"),
    y: z.number().describe("Y coordinate")
  ...
  style: z.object({
    fillColor: z.string().optional().nullable().describe("Fill color"),
    textColor: z.string().optional().nullable().describe("Text color")
  }).optional().nullable()
});
...
const textSchema = z.object({
  ...
  style: z.object({
    color: z.string().optional().nullable().describe("Text color (hex format, e.g. #000000)"),
