...
const deleteGroupTool: ToolSchema = {
  ...
  args: {
    ...
    deleteItems: z.boolean().optional().nullable().describe("Indicates whether the items should be removed. Set to true to delete items in the group, false to keep them")
  },
