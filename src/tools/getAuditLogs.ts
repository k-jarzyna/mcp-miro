...
const getAuditLogsTool: ToolSchema = {
  ...
  args: {
    ...
    limit: z.number().optional().nullable().describe("Maximum number of results to return (default: 100)"),
    sorting: z.enum(["ASC", "DESC"]).optional().nullable().describe("Sort order for results (default: ASC)")
  },
