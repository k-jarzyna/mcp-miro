...
const getBoardContentLogsTool: ToolSchema = {
  ...
  args: {
    ...
    boardIds: z.array(z.string()).optional().nullable().describe("List of board IDs to filter by"),
    emails: z.array(z.string()).optional().nullable().describe("List of user emails to filter by"),
    ...
    sorting: z.enum(["asc", "desc"]).optional().nullable().describe("Sort order for results")
  },
