...
const updateAppCardItemTool: ToolSchema = {
  ...
  args: {
    ...
    data: z.object({
      title: z.string().optional().nullable().describe("Updated title of the app card"),
      description: z.string().optional().nullable().describe("Updated description of the app card"),
      status: z.string().optional().nullable().describe("Updated status text of the app card"),
      ...
      })).optional().nullable().describe("Updated custom fields to display on the app card")
    }).optional().nullable().describe("The updated content and configuration of the app card"),
    position: z.object({
      x: z.number().describe("Updated X coordinate of the app card"),
      y: z.number().describe("Updated Y coordinate of the app card")
    }).optional().nullable().describe("Updated position of the app card on the board"),
    geometry: z.object({
      width: z.number().optional().nullable().describe("Updated width of the app card"),
      height: z.number().optional().nullable().describe("Updated height of the app card")
    }).optional().nullable().describe("Updated dimensions of the app card")
  },
