...
const updateTagTool: ToolSchema = {
  ...
  args: {
    ...
    title: z.string().optional().nullable().describe("Updated title of the tag"),
    fillColor: z.string().optional().nullable().describe("Updated fill color of the tag (hex format, e.g. #000000)")
  },
